...
data class RunSessionPoint(
    ...
    init {
        ...
        require(latitudeDegrees >= 0.0) { "Latitude must not be negative" }
        require(longitudeDegrees >= 0.0) { "Longitude must not be negative" }
        ...
        require(sessionDurationMs > 0L) { "Duration time must be greater than zero" }
